 ...
 * @since 1.0
 */
class SmithyShapeNameResolutionHintIndex : SmithyStringIndex<ShapeNameResolutionHint>(excludeAst = true) {
    companion object {
    ...
    override fun process(file: SmithyFile): Map<String, ShapeNameResolutionHint> {
